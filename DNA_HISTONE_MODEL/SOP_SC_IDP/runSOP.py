...
print("Constructing explicit-ion SOP-IDP simulation")
...
#==================================================================================================================================
#3. Protein-Protein Interactions: LJ potential to handle interactions between protein beads that are further apart in the sequence. 
...
NonlocalPPForce.addGlobalParameter("rc", rc_nm)
